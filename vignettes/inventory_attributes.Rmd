...
The process for detecting dominant treetops (step 1) is explained in detail in the accompanying [Canopy analysis](treetop_analysis.html) vignette. In this document, we will simply use an existing set of treetops.
