...
To have this function applied using `sp_summarise`, it must be put into a named list. Naming the functions in the list is needed for labeling the function's outputs.
